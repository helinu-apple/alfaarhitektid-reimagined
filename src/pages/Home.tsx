...
const Home = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative h-[300px] sm:h-[400px] md:h-[500px] bg-muted flex items-center justify-center overflow-hidden">
        <img 
          src={heroBuilding} 
      ...
      <section className="container mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto">
          ...
          <Link 
            to="/firmast"
            className="group relative p-6 sm:p-8 border-2 border-border hover:border-foreground transition-all duration-300 bg-background hover:shadow-lg"
          >
            ...
            <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-foreground group-hover:translate-x-1 transition-transform uppercase">
              PROJEKTEERIMINE
            </h3>
      ...
      <main className="container mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16">
          ...
          <div className="lg:col-span-2">
            <h1 className="text-2xl sm:text-3xl font-light mb-6 sm:mb-8 text-foreground">
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-4">Meie tegevusvaldkonnad on</p>

            <ul className="space-y-2 mb-8 sm:mb-12">
            ...
            {/* Contact Section */}
            <section id="kontakt" className="border-t border-border pt-8 sm:pt-12 scroll-mt-24">
              <h2 className="text-xl sm:text-2xl font-light mb-6 sm:mb-8 text-foreground flex items-center gap-3">
          ...
          <div className="space-y-8 sm:space-y-12">
            {/* Projects */}
            <section>
              <h2 className="text-lg sm:text-xl font-light mb-4 sm:mb-6 text-foreground border-b border-border pb-2 flex items-center gap-3">
                <span className="w-2 h-2 border border-foreground rotate-45"></span>
                Projektid
              </h2>
